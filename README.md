...
Updated Week 8 Word file: [downloads/MW_Wk5_to_wk8_Edit_6Sep26.docx](downloads/MW_Wk5_to_wk8_Edit_6Sep26.docx) (epigraph + usage/tracking appendix + **Ethical Considerations** offering). Ethics paste-ready: [docs/ethical-considerations-offering.md](docs/ethical-considerations-offering.md). Usage log: [docs/change-tracking-update.md](docs/change-tracking-update.md).
