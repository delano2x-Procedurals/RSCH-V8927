...
Updated Week 8 Word file: [downloads/MW_Wk5_to_wk8_Edit_6Sep26.docx](downloads/MW_Wk5_to_wk8_Edit_6Sep26.docx). Offerings: [ethics](docs/ethical-considerations-offering.md) · [data analysis](docs/data-analysis-offering.md). Usage log: [docs/change-tracking-update.md](docs/change-tracking-update.md).
